...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "STAR ENTERPRISES — GST Billing & Stock ERP" },
      { name: "description", content: "Wholesale GST billing and stock management ERP for STAR ENTERPRISES Nanded." },
      { property: "og:title", content: "STAR ENTERPRISES — GST Billing & Stock ERP" },
      { property: "og:description", content: "Wholesale GST billing and stock management ERP." },
