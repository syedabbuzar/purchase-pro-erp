...
export const Route = createFileRoute("/_authenticated/billing")({
  validateSearch: (search: Record<string, unknown>) => ({
    edit: typeof search.edit === "string" || typeof search.edit === "number" ? Number(search.edit) || undefined : undefined,
    duplicate: typeof search.duplicate === "string" || typeof search.duplicate === "number" ? Number(search.duplicate) || undefined : undefined,
  }),
  component: BillingPage,
  head: () => ({ meta: [{ title: "New Bill — STAR ENTERPRISES" }] }),
});
...
function BillingPage() {
  ...
  const saveInvoice = async () => {
    ...
    try {
      ...
      navigate({ to: "/invoice-preview/$id", params: { id: String(invoiceId) } });
    } catch (e) {
